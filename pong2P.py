...
class Pong2P:
    ...
    def __init__(self, window: Window):
        ...
        self.player2 = Paddle(2, self.game_window)
        ...
        while True:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    if event.key == ord('p'):
                        self.player2.UP2 = True
                        self.player2.DOWN2 = False
                        self.player2.NEUTRAL2 = False
                    elif event.key == ord('.'):
                        self.player2.UP2 = False
                        self.player2.DOWN2 = True
                        self.player2.NEUTRAL2 = False
                    ...
                    if event.key == ord('p') or event.key == ord('.'):
                        self.player2.NEUTRAL2 = True
                        self.player2.UP2 = False
                        self.player2.DOWN2 = False

            # Update the score board
            score_board = BASIC_FONT.render(str(player1_score) + "           " + \
